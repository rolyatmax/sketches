...
fs.writeFileSync(path.resolve(process.cwd(), `${plotName}-plot-seed${settings.seed}-1.svg`), svg1)
fs.writeFileSync(path.resolve(process.cwd(), `${plotName}-plot-seed${settings.seed}-2.svg`), svg2)
