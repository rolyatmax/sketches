...
gui.add(settings, 'hueDivs', 1, 5).step(1)
    ...
    renderCube = regl({
      vert: glsl`
        ...
        void main (void) {
          ...
          float hStart = floor(d * hueDivs) / hueDivs + hueStart;
          float hue = h * hueSpread + hStart;
