...
const sketch = ({ render }) => {
  ...
  gui.add(settings, 'circleGranularity', 3, 8).step(1).onChange(regenerateCircles)
  ...
  function createCircles () {
    ...
    pts = []
    for (let i = 0; i < settings.circleGranularity; i++) {
      const rads = i / settings.circleGranularity * Math.PI * 2
