...
const PLOTNAME = '2022.12.13-22.10.01'

// TODO: write a force directed layout simulator here
// it needs to:
// take a list of all the shapes
// for each shape, look at the closest shapes to it
//   for each neighbor, calculate distance,
//   if too close, push it away by some small step
// at the end, add each of the push away amounts
// back to the shapes position, and repeat for
// a fixed number of iterations or until no shapes
// are too close
